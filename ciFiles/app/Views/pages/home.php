    ...
    <section id="projects-desktop" style="background-image: url('<?php echo site_url("assets/images/Projects.png"); ?>'); background-size: 100% 100%; padding: 5% 0 12% 0;" class="text-center">
        <div class="container text-center">
            <div class="row" data-aos="zoom-in">
                ...
                <div class="col-4">
                    <div class="project-grid-box" style="background-image: url('<?php echo site_url("assets/images/projects_02.jpg") ?>'); background-size: cover;">
                        <div class="project-grid-meta">
                            <h4 class="project-grid-title">Precious Harmony</h4>
                            <h6 class="project-grid-title">1 BHK</h6>
                        </div>
                ...
                <div class="col-4">
                    <div class="project-grid-box" style="background-image: url('<?php echo site_url("assets/images/projects_03.jpg") ?>'); background-size: cover;">
                        <div class="project-grid-meta">
